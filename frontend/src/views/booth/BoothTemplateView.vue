          ...
          <div class="selected-template-area">
            <div class="selected-template">
              <div class="template-images">
                <div v-for="image in imagesToShow.value" :key="image" class="image-wrapper" @click="selectImage(image)">
                  <img :src="image" :class="{ selected: selectedImage.value === image }" alt="Template Image" />
                </div>
              </div>
              <div class="box-footer">
                <button @click="goToPrevious">이전</button>
                <button @click="goToNext" :disabled="!selectedImage.value">다음</button>
              </div>
            </div>
          </div>
        </BoothBack>
        ...
        <BoothBack class="booth-select-box">
          <div class="select-box">
            ...
            <div class="select-temp-box">
              <div class="temp-area">
                <div v-for="template in templates" :key="template.text" class="array-area">
                  <button class="array-button" @click="selectTemplate(template)">
                    {{ template.text }}
                  </button>
                </div>
              </div>
